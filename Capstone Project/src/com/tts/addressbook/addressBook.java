...
//Java class named addressBook
public class addressBook {
public static Scanner input;
Entry bookEntry = new Entry();// object of class Entry
// Create an arraylist of entry objects
static ArrayList<Entry> Book = new ArrayList<Entry>();

// main() method which is entry point of the class addressBook
...
// calling method add from Book class
Book.add(new Entry(first, last, phone, email));
System.out.println("\nAdded new entry!\n");// print message
printMenu();// call method to display menu
}
